...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_FILES['profile_picture'])) {
    ...
    try {
        ...
        /* UPDATE DATABASE */
        $update_picture = mysqli_prepare($conn, "UPDATE users SET profile_picture = ? WHERE user_id = ?");
        mysqli_stmt_bind_param($update_picture, "si", $filename, $user_id);
        ...
        <div class="profile-details">
            ...
            <div class="profile-list">
                <div class="list-item">
                    ...
                    <input type="text" value="<?php echo e($data['fullname']); ?>" readonly>
                </div>
                <div class="list-item">
